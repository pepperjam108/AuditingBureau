      ...
      <el-row :gutter="10">
        <el-col :span="8">
          <el-form-item label="资质名称">
            <el-input
              v-model="searchform.quafc_name"
              placeholder=""
              :disabled="this.paramform.param == null || this.searchform.quafc_name !='' ? false : true"
              @input="handlerChange"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="10">
          <upload :interfaceNum="23" paramName="quafc_name" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="23" paramName="quafc_name"></upload_second>
        </el-col> -->
      </el-row>
      <el-row>
        <el-col :span="8">
          <el-form-item label="资质证书编号">
            <el-input
              v-model="searchform.quafc_no"
              placeholder=""
              :disabled="this.paramform.param == null || this.searchform.quafc_no !='' ? false : true"
              @input="handlerChange"
              aria-disabled="true"
            ></el-input>
          </el-form-item>
        ...
        <el-col :span="10">
          <upload  :interfaceNum="23" paramName="quafc_no" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="23" paramName="quafc_no"></upload_second>
        </el-col> -->
      </el-row>
      <el-row>
        <el-col :span="8">
        ...
        <el-col :span="10">
          <upload :interfaceNum="23" paramName="uni_scid" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
      </el-row>
      ...
      if (e) {
        ...
        Object.keys(this.searchform).forEach(key=>{
          if(this.searchform[key] != ""){
            ...
            this.doawloadurl = BaseUrl+"/interface/downloadParam?param="+this.searchform[key]+"&interfaceNum=23&paramName="+key;
          }
        })
      } else {
