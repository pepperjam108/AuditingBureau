      ...
      <el-row :gutter="10">
        <el-col :span="8">
          <el-form-item label="分支机构名称">
            <el-input
              v-model="searchform.branch_org_name"
              placeholder=""
              :disabled="this.paramform.param == null || this.searchform.branch_org_name !='' ? false : true"
              @input="handlerChange"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="10">
          <upload :interfaceNum="4" paramName="branch_org_name" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="4" paramName="branch_org_name"></upload_second>
        </el-col> -->
      </el-row>
      <el-row>
        <el-col :span="8">
          <el-form-item label="注册号">
            <el-input
              v-model="searchform.ent_regi_no"
              placeholder=""
              :disabled="this.paramform.param == null || this.searchform.ent_regi_no !='' ? false : true"
              @input="handlerChange"
              aria-disabled="true"
            ></el-input>
          </el-form-item>
        ...
        <el-col :span="10">
          <upload  :interfaceNum="4" paramName="ent_regi_no" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="4" paramName="ent_regi_no"></upload_second>
        </el-col> -->
      </el-row>
      <el-row :gutter="10">
        <el-col :span="8">
        ...
        <el-col :span="10">
          <upload  :interfaceNum="4" paramName="uni_scid" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showdatafromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="4" paramName="uni_scid"></upload_second>
        </el-col> -->
      </el-row>
      <el-row :gutter="10">
      ...
      if (e) {
        ...
        Object.keys(this.searchform).forEach(key=>{
          if(this.searchform[key] != ""){
            this.doawloadurl = BaseUrl+"/interface/downloadParam?param="+this.searchform[key]+"&interfaceNum=4&paramName="+key;
