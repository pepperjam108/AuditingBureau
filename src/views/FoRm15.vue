  ...
  <div class="form_wrap">
    <el-form :model="searchform">
      <el-row :gutter="10">
        ...
        <el-col :span="10">
          <upload :interfaceNum="14" paramName="ent_name" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="14" paramName="ent_name"></upload_second>
        </el-col> -->
      </el-row>
      <el-row>
        <el-col :span="8">
        ...
        <el-col :span="10">
          <upload  :interfaceNum="14" paramName="legal_certi_no" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="14" paramName="legal_certi_no"></upload_second>
        </el-col> -->
      </el-row>
      <el-row :gutter="10">
        <el-col :span="8">
        ...
        <el-col :span="10">
          <upload  :interfaceNum="14" paramName="legal_name" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="14" paramName="legal_name"></upload_second>
        </el-col> -->
      </el-row>
      <el-row :gutter="10">
        <el-col :span="8">
          <el-form-item label="法定代表人/负责人/投资人/执行合伙企业事务的合伙人">
            <el-input
              v-model="searchform.partner_name"
              placeholder=""
              :disabled="this.paramform.param == null || this.searchform.partner_name !=''? false : true"
              @input="handlerChange"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="10">
          <upload  :interfaceNum="14" paramName="partner_name" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="14" paramName="partner_name"></upload_second>
        </el-col> -->
      </el-row>
      <el-row :gutter="10">
        <el-col :span="8">
        ...
        <el-col :span="10">
          <upload  :interfaceNum="14" paramName="reg_no" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="14" paramName="reg_no"></upload_second>
        </el-col> -->
      </el-row>
      <el-row >
        <el-col :span="8">
        ...
        <el-col :span="10">
          <upload :interfaceNum="14" paramName="uniscid" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="14" paramName="uniscid"></upload_second>
        </el-col> -->
      </el-row>
      ...
      if (e) {
        ...
        Object.keys(this.searchform).forEach(key=>{
          if(this.searchform[key] != ""){
            ...
            this.doawloadurl = BaseUrl+"/interface/downloadParam?param="+this.searchform[key]+"&interfaceNum=14&paramName="+key;
          }
        })
      } else {
