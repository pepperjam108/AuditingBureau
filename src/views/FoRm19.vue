  ...
  <div class="form_wrap">
    <el-form :model="searchform">
      <el-row :gutter="10">
        ...
        <el-col :span="10">
          <upload :interfaceNum="18" paramName="pripid_code" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="18" paramName="pripid_code"></upload_second>
        </el-col> -->
      </el-row>
      <el-row :gutter="10">
        <el-col :span="8">
        ...
        <el-col :span="10">
          <upload  :interfaceNum="18" paramName="reg_no" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="18" paramName="reg_no"></upload_second>
        </el-col> -->
      </el-row>
      <el-row>
        <el-col :span="8">
        ...
        <el-col :span="10">
          <upload :interfaceNum="18" paramName="uniscid" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="18" paramName="uniscid"></upload_second>
        </el-col> -->
      </el-row>
      ...
      if (e) {
        ...
        Object.keys(this.searchform).forEach(key=>{
          if(this.searchform[key] != ""){
            ...
            this.doawloadurl = BaseUrl+"/interface/downloadParam?param="+this.searchform[key]+"&interfaceNum=18&paramName="+key;
          }
        })
      } else {
