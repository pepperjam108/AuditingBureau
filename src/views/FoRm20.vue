  ...
  <div class="form_wrap">
    <el-form :model="searchform">
      <el-row :gutter="10">
        ...
        <el-col :span="10">
          <upload :interfaceNum="19" paramName="busi_regi_no" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="19" paramName="busi_regi_no"></upload_second>
        </el-col> -->
      </el-row>
      <el-row>
        <el-col :span="8">
        ...
        <el-col :span="10">
          <upload  :interfaceNum="19" paramName="pri_code" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="19" paramName="pri_code"></upload_second>
        </el-col> -->
      </el-row>
      <el-row :gutter="10">
        <el-col :span="8">
        ...
        <el-col :span="10">
          <upload  :interfaceNum="19" paramName="uni_scid" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="19" paramName="uni_scid"></upload_second>
        </el-col> -->
      </el-row>
      ...
      if (e) {
        ...
        Object.keys(this.searchform).forEach(key=>{
          if(this.searchform[key] != ""){
            ...
            this.doawloadurl = BaseUrl+"/interface/downloadParam?param="+this.searchform[key]+"&interfaceNum=19&paramName="+key;
          }
        })
      } else {
