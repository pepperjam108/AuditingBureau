<template>
  <div class="form_wrap">
    <el-form :model="searchform">
      <el-row :gutter="10">
        <el-col :span="8">
          <el-form-item label="股权出质变更ID">
            <el-input
              v-model="searchform.pled_alt_no"
              placeholder=""
              :disabled="this.paramform.param == null || this.searchform.pled_alt_no !='' ? false : true"
              @input="handlerChange"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="10">
          <upload :interfaceNum="8" paramName="pled_alt_no" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="8" paramName="pled_alt_no"></upload_second>
        </el-col> -->
      </el-row>
      <el-row>
        <el-col :span="8">
          <el-form-item label="股权出质登记ID">
            <el-input
              v-model="searchform.pled_regi_no"
              placeholder=""
              :disabled="this.paramform.param == null || this.searchform.pled_regi_no !='' ? false : true"
              @input="handlerChange"
              aria-disabled="true"
            ></el-input>
          </el-form-item>
        ...
        <el-col :span="10">
          <upload  :interfaceNum="8" paramName="pled_regi_no" v-on:showdatachildren="showdatafromChild" v-on:showfieldschildren="showfiledsfromChild"></upload>
        </el-col>
        <!-- <el-col :span="5">
          <upload_second :interfaceNum="8" paramName="pled_regi_no"></upload_second>
        </el-col> -->
      </el-row>
      <el-row :gutter="10">
      ...
      if (e) {
        ...
        Object.keys(this.searchform).forEach(key=>{
          if(this.searchform[key] != ""){
            ...
            this.doawloadurl = BaseUrl+"/interface/downloadParam?param="+this.searchform[key]+"&interfaceNum=8&paramName="+key;
          }
        })
      } else {
